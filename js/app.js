...
function updateAtoolDisplay() {
  ...
  try {
    ...
    accounts.forEach(function(a) {
      ...
      html += "<button onclick="switchAccount('" + a.account_id + "')" style="display:block;width:100%;text-align:left;padding:8px 12px;margin-bottom:4px;border-radius:6px;border:1px solid " + border + ";background:" + bg + ";color:#fff;cursor:pointer">" + label + (active ? " ✓" : "") + "</button>";
    });
    el.innerHTML = html;
